$(document).ready(function() {
  ...
  // an Author
  $(document).on("submit", ".form-group", handleMeetupFormSubmit);
  $(document).on("click", ".delete-meetup", handleDeleteButtonPress);

  // Getting the initial list of Meetups
  getMeetups();

  // A function to handle what happens when the form is submitted to create a new Meetup
  function handleMeetupFormSubmit(event) {
...
>>>>>>> 13f2502df6ba49b1612bbedac7a84f8d693f3680
